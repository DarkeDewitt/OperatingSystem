...
thread_unblock (struct thread *t) 
{
 ...
 // list_push_back (&ready_list, &t->elem);
  list_insert_ordered(&ready_list, &t->elem, (list_less_func *)&more_than, NULL);
  t->status = THREAD_READY;
  intr_set_level (old_level);
}

bool
more_than(const struct list_elem *a,
...
//  list_push_back (&ready_list, &cur->elem);
  list_insert_ordered(&ready_list, &cur->elem, (list_less_func *)&more_than, NULL);
